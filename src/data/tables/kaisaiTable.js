...
['3', 'Pompa obiegowa CO KAMAN PRO', 'szt.', '1', 'Zapewnia prawidłowy obieg czynnika grzewczego w instalacji.'],
 ...
 ['4', 'Komplet elementów hydraulicznych', 'kpl.', '1', 'W tym: zawory kulowe, zawory zwrotne, odpowietrzniki automatyczne, filtry, trójniki, kształtki, nyple, redukcje i pozostała armatura niezbędna do wykonania instalacji wodnej.'],
  ...
  ['11', 'Sterownik bezprzewodowy', 'szt.', '1', 'Do zarządzania pracą pompy z funkcją auto adaptacji.'],
...
const kaisaiHydrobox_12kW_base = kaisaiHydrobox_10kW_base.map(row =>
  row[0] === '1'
    ...
    : row[0] === '2'
      ? ['2', 'Moduł wewnętrzny Hydrobox (KMK-160RY3)', 'szt.', '1', 'Kaisai Arctic | hydrobox | bez zintegrowanego zasobnika CWU | grzałka 3/6 kW, 400V | naczynie wzbiorcze 10L | do ogrzewania i przygotowania CWU przez zewnętrzny zbiornik.']
      : [...row]
);

const kaisaiHydrobox_16kW_base = kaisaiHydrobox_10kW_base.map(row =>
  row[0] === '1'
