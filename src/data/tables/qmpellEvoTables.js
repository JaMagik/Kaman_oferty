...
const qmpell_8kW_base = [
  ['1', 'Kocioł na pellet – Pereko QMPell 8 kW', 'szt.', '1', 'Kocioł 5 klasy z podajnikiem oraz zasobnikiem na pellet.'],
...
const qmpell_12kW_base = qmpell_8kW_base.map(row => 
  row[0] === '1'
    ? ['1', 'Kocioł na pellet – Pereko QMPell 12 kW', 'szt.', '1',  'Kocioł 5 klasy z podajnikiem oraz zasobnikiem na pellet.']
    : [...row]
);
...
const qmpell_18kW_base = qmpell_8kW_base.map(row => 
  row[0] === '1'
    ? ['1', 'Kocioł na pellet – Pereko QMPell 18 kW', 'szt.', '1',  'Kocioł 5 klasy z podajnikiem oraz zasobnikiem na pellet.']
    : [...row]
);
