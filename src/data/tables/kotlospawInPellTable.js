// --- Kotlospaw In-pell 7 kW ---
const inPell_7kW_base = [
  ['1', 'Kocioł na pellet Kotłospaw In-pell 7 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy z palnikiem pelletowym i kompaktowym zasobnikiem pelletu.', 'common'],
...
const createInPellTable = (power) => inPell_7kW_base.map(row =>
  row[0] === '1'
    ? ['1', `Kocioł na pellet Kotłospaw In-pell ${power}`, 'szt.', '1', 'Automatyczny kocioł 5 klasy z palnikiem pelletowym i kompaktowym zasobnikiem pelletu.', 'common']
    : [...row]
);

export const kotlospawInPellBaseTables = {
  'Kotlospaw In-pell': {
    '7 kW': inPell_7kW_base,
    '9 kW': createInPellTable('9 kW'),
    '11 kW': createInPellTable('11 kW'),
    '13 kW': createInPellTable('13 kW'),
  },
};
