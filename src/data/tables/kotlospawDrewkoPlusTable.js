...
const drewkoPlus_12kW_base = [
  ['1', 'Kocioł na drewno – Kotłospaw Drewko Plus 12 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy na drewno, wyposażony w duży zasyp, wysoką sprawność, spełniający wymagania Ekoprojektu.'],
...
const drewkoPlus_18kW_base = drewkoPlus_12kW_base.map(row =>
  row[0] === '1'
    ? ['1', 'Kocioł na drewno – Kotłospaw Drewko Plus 18 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy na drewno, wyposażony w duży zasyp, wysoką sprawność, spełniający wymagania Ekoprojektu.']
    : [...row]
);
...
const drewkoPlus_24kW_base = drewkoPlus_12kW_base.map(row =>
  row[0] === '1'
    ? ['1', 'Kocioł na drewno – Kotłospaw Drewko Plus 24 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy na drewno, wyposażony w duży zasyp, wysoką sprawność, spełniający wymagania Ekoprojektu.']
    : [...row]
);

// --- Mapping nazw ---
export const kotlospawDrewkoPlusBaseTables = {
    'Kotlospaw drewko plus': { // Klucz odpowiadający 'deviceType' dla Kotłospaw Drewko Plus
