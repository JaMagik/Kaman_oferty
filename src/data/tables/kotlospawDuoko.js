// --- Kotłospaw DuOKO 12 kW ---
const duOKO_12kW_base = [
  ['1', 'Kocioł na pellet Kotłospaw DuOKO 12 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy z palnikiem EASY ROT i zasobnikiem pelletu wolnostojącym.', 'common'],
...
// --- Kotłospaw DuOKO 18 kW ---
const duOKO_18kW_base = duOKO_12kW_base.map(row =>
  row[0] === '1'
    ?['1', 'Kocioł na pellet Kotłospaw DuOKO 18 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy z palnikiem EASY ROT i zasobnikiem pelletu wolnostojącym.', 'common']
    : [...row]
);

// --- Kotłospaw DuOKO 24 kW ---
const duOKO_24kW_base = duOKO_12kW_base.map(row =>
  row[0] === '1'
    ? ['1', 'Kocioł na pellet Kotłospaw DuOKO 24 kW', 'szt.', '1', 'Automatyczny kocioł 5 klasy z palnikiem EASY ROT i zasobnikiem pelletu wolnostojącym.', 'common']
    : [...row]
);

// --- Mapping nazw ---
export const kotlospawduOKOBaseTables = {
    'Kotlospaw duoko': { // Klucz odpowiadający 'deviceType' dla Kotłospaw Drewko Plus
  '12 kW': duOKO_12kW_base,
  '18 kW': duOKO_18kW_base,
  '24 kW': duOKO_24kW_base,
    }
};
