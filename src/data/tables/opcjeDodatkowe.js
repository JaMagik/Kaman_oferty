// ścieżka: src/data/tables/opcjeDodatkowe.js
...
export const opcjeDlaPompCiepla = [
    ...
    ['9', 'Demontaż starego źródła ciepła', 'Odłączenie i przestawienie kotła; możliwość wywiezienia wózkiem paletowym.', 'kpl.', '500zł'],
...
export const opcjeDlaKotlow = [
    ['1', 'Separator zanieczyszczeń magnetyczny (odmulnik)', 'Zabezpieczenie instalacji przed zanieczyszczeniami krążącymi w wodzie.', 'szt.', '560zł'],
    ['2', 'Druga strefa grzewcza z podmieszaniem do podłogówki', 'Zawór mieszający z siłownikiem, pompa obiegowa, osprzęt - umożliwia pracę podłogówki z inną temperaturą.', 'szt.', '1350zł'],
    ['3', 'Zbiornik CWU 300 L', 'Pojemność dostosowana do potrzeb rodziny, współpracuje z kotłem.', 'szt.', '700zł'],
    ...
    ['6', 'Demontaż starego źródła ciepła', 'Analogicznie jak w przypadku pomp ciepła, w tym możliwość wyniesienia kotła.', 'szt.', '500zł'],
